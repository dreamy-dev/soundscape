 ...
 */const gr=typeof window!="undefined"&&window.customElements!=null&&window.customElements.polyfillWrapFlushCallback!==void 0,ve=(e,t,r=null)=>{for(;t!==r;){const o=t.nextSibling;e.removeChild(t),t=o}},L=`{{lit-${String(Math.random()).slice(2)}}}`,so=`<!--${L}-->`,br=new RegExp(`${L}|${so}`);class ao{constructor(t,r){this.parts=[],this.element=r;const o=[],i=[],n=document.createTreeWalker(r.content,133,null,!1);let s=0,d=-1,a=0;const{strings:l,values:{length:u}}=t;for(;a<u;){const c=n.nextNode();if(c!==null){if(d++,c.nodeType===1){if(c.hasAttributes()){const h=c.attributes,{length:p}=h;let f=0;for(let m=0;m<p;m++)_r(h[m].name,"$lit$")&&f++;for(;f-- >0;){const m=l[a],E=ge.exec(m)[2],k=E.toLowerCase()+"$lit$",A=c.getAttribute(k);c.removeAttribute(k);const S=A.split(br);this.parts.push({type:"attribute",index:d,name:E,strings:S}),a+=S.length-1}}c.tagName==="TEMPLATE"&&(i.push(c),n.currentNode=c.content)}else if(c.nodeType===3){const h=c.data;if(h.indexOf(L)>=0){const p=c.parentNode,f=h.split(br),m=f.length-1;for(let E=0;E<m;E++){let k,A=f[E];if(A==="")k=j();else{const S=ge.exec(A);S!==null&&_r(S[2],"$lit$")&&(A=A.slice(0,S.index)+S[1]+S[2].slice(0,-5)+S[3]),k=document.createTextNode(A)}p.insertBefore(k,c),this.parts.push({type:"node",index:++d})}f[m]===""?(p.insertBefore(j(),c),o.push(c)):c.data=f[m],a+=m}}else if(c.nodeType===8)if(c.data===L){const h=c.parentNode;c.previousSibling!==null&&d!==s||(d++,h.insertBefore(j(),c)),s=d,this.parts.push({type:"node",index:d}),c.nextSibling===null?c.data="":(o.push(c),d--),a++}else{let h=-1;for(;(h=c.data.indexOf(L,h+1))!==-1;)this.parts.push({type:"node",index:-1}),a++}}else n.currentNode=i.pop()}for(const c of o)c.parentNode.removeChild(c)}}const _r=(e,t)=>{const r=e.length-t.length;return r>=0&&e.slice(r)===t},lo=e=>e.index!==-1,j=()=>document.createComment(""),ge=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function yr(e,t){const{element:{content:r},parts:o}=e,i=document.createTreeWalker(r,133,null,!1);let n=vt(o),s=o[n],d=-1,a=0;const l=[];let u=null;for(;i.nextNode();){d++;const c=i.currentNode;for(c.previousSibling===u&&(u=null),t.has(c)&&(l.push(c),u===null&&(u=c)),u!==null&&a++;s!==void 0&&s.index===d;)s.index=u!==null?-1:s.index-a,n=vt(o,n),s=o[n]}l.forEach(c=>c.parentNode.removeChild(c))}const qi=e=>{let t=e.nodeType===11?0:1;const r=document.createTreeWalker(e,133,null,!1);for(;r.nextNode();)t++;return t},vt=(e,t=-1)=>{for(let r=t+1;r<e.length;r++){const o=e[r];if(lo(o))return r}return-1};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Ki=new WeakMap,xt=e=>typeof e=="function"&&Ki.has(e),R={},wr={};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const en=new class{handleAttributeExpressions(e,t,r,o){const i=t[0];return i==="."?new Gi(e,t.slice(1),r).parts:i==="@"?[new Zi(e,t.slice(1),o.eventContext)]:i==="?"?[new Yi(e,t.slice(1),r)]:new uo(e,t,r).parts}handleTextExpression(e){return new Kt(e)}};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
*/const _o="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,yo=Symbol();class $r{constructor(t,r){if(r!==yo)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return this._styleSheet===void 0&&(_o?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const an=(e,...t)=>{const r=t.reduce((o,i,n)=>o+(s=>{if(s instanceof $r)return s.cssText;if(typeof s=="number")return s;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${s}. Use 'unsafeCSS' to pass non-literal values, but
            take care to ensure page security.`)})(i)+e[n+1],e[0]);return new $r(r,yo)};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var $e=class extends Ot{constructor(){super(...arguments);this.hasSlotController=new Ao(this,"footer","header","image")}render(){return Ne`
      <div
        part="base"
    ...
    `}};$e.styles=$n;$e=v([Me("sl-card")],$e);var Mn=Jt`
  ${Re}
 ...
 */function Ir(e,t,r){const o=new CustomEvent(t,kt({bubbles:!0,cancelable:!1,composed:!0,detail:{}},r));return e.dispatchEvent(o),o}var g=class extends Ot{constructor(){super(...arguments);this.formSubmitController=new jn(this,{form:e=>{if(e.hasAttribute("form")){const t=e.getRootNode(),r=e.getAttribute("form");return t.getElementById(r)}return e.closest("form")}}),this.hasSlotController=new Ao(this,"[default]","prefix","suffix"),this.localize=new Ro(this),this.hasFocus=!1,this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button"}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}handleBlur(){this.hasFocus=!1,Ir(this,"sl-blur")}handleFocus(){this.hasFocus=!0,Ir(this,"sl-focus")}handleClick(e){if(this.disabled||this.loading){e.preventDefault(),e.stopPropagation();return}this.type==="submit"&&this.formSubmitController.submit(this),this.type==="reset"&&this.formSubmitController.reset(this)}render(){const e=!!this.href,t=e?jr`a`:jr`button`;return ue`
      ...
      >
        ...
        ${this.caret?ue`
              ...
              `:""}
        ${this.loading?ue`<sl-spinner></sl-spinner>`:""}
      </${t}>
...
`;var Jn=Object.defineProperty,Yn=Object.getOwnPropertyDescriptor,Uo=(e,t,r,o)=>{for(var i=o>1?void 0:o?Yn(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(i=(o?s(t,r,i):s(i))||i);return o&&i&&Jn(t,r,i),i};let Ee=class extends M{constructor(){super();this.message="Welcome!"}static get styles(){return[Kn,dt`
            ...
            `]}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}render(){return z`
        ...
        `}};Uo([P()],Ee.prototype,"message",2);Ee=Uo([Pt("app-home")],Ee);var Gn=Object.defineProperty,Xn=Object.getOwnPropertyDescriptor,Le=(e,t,r,o)=>{for(var i=o>1?void 0:o?Xn(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(i=(o?s(t,r,i):s(i))||i);return o&&i&&Gn(t,r,i),i};let Wt=class extends M{constructor(){super();this.title="Soundscape",this.enableBack=!1}static get styles(){return dt`
            header {
                display: flex;
                justify-content: space-between;
                align-items: center;
        ...
        `}render(){return z`
            <header>
                ...
                <div class="logo">
                    ...
                    ${this.enableBack?null:z`<h1>${this.title}</h1>`}
                </div>
        ...
        `}};Tt([P({type:String})],lt.prototype,"title",2);Tt([P({type:String})],lt.prototype,"audio",2);Tt([P({type:String})],lt.prototype,"bgimage",2);Tt([P({type:Boolean})],lt.prototype,"enableBack",2);lt=Tt([Pt("app-modal")],lt);var ts=Object.defineProperty,es=Object.getOwnPropertyDescriptor,ht=(e,t,r,o)=>{for(var i=o>1?void 0:o?es(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(i=(o?s(t,r,i):s(i))||i);return o&&i&&ts(t,r,i),i};let K=class extends M{constructor(){super();this.title="Example Title",this.bgimage="assets/covers/balloon-ride.jpg",this.audio="assets/audio/water_drips.mp3",this.enableBack=!1,this.active=!1}static get styles(){return dt`
            nav a {
                margin-left: 10px;
            }
        ...
        `}};ht([P({type:String})],K.prototype,"title",2);ht([P({type:String})],K.prototype,"bgimage",2);ht([P({type:String})],K.prototype,"audio",2);ht([P({type:Boolean})],K.prototype,"enableBack",2);ht([P({type:Boolean,reflect:!0})],K.prototype,"active",2);K=ht([Pt("app-card")],K);var rs=Object.defineProperty,os=Object.getOwnPropertyDescriptor,is=(e,t,r,o)=>{for(var i=o>1?void 0:o?os(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(i=(o?s(t,r,i):s(i))||i);return o&&i&&rs(t,r,i),i};let zr=class extends M{static get styles(){return dt`
            #routerOutlet > * {
                width: 100% !important;
            }
