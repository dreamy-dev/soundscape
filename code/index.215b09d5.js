var Do=Object.defineProperty,Ho=Object.defineProperties;var jo=Object.getOwnPropertyDescriptors;var He=Object.getOwnPropertySymbols;var Io=Object.prototype.hasOwnProperty,zo=Object.prototype.propertyIsEnumerable;var je=(e,t,r)=>t in e?Do(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Ie=(e,t)=>{for(var r in t||(t={}))Io.call(t,r)&&je(e,r,t[r]);if(He)for(var r of He(t))zo.call(t,r)&&je(e,r,t[r]);return e},ze=(e,t)=>Ho(e,jo(t));const Vo=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerpolicy&&(n.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?n.credentials="include":i.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(i){if(i.ep)return;i.ep=!0;const n=r(i);fetch(i.href,n)}};Vo();const Fo="modulepreload",Ve={},Wo="/soundscape/",qo=function(t,r){return!r||r.length===0?t():Promise.all(r.map(o=>{if(o=`${Wo}${o}`,o in Ve)return;Ve[o]=!0;const i=o.endsWith(".css"),n=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${n}`))return;const s=document.createElement("link");if(s.rel=i?"stylesheet":Fo,i||(s.as="script",s.crossOrigin=""),s.href=o,document.head.appendChild(s),i)return new Promise((d,a)=>{s.addEventListener("load",d),s.addEventListener("error",()=>a(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())};/**
 * @license
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Ki=new WeakMap,St=e=>typeof e=="function"&&Ki.has(e),R={},$r={};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
`,Ao=class{constructor(e,...t){this.slotNames=[],(this.host=e).addController(this),this.slotNames=t,this.handleSlotChange=this.handleSlotChange.bind(this)}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if(t.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}handleSlotChange(e){const t=e.target;(this.slotNames.includes("[default]")&&!t.name||t.name&&this.slotNames.includes(t.name))&&this.host.requestUpdate()}},Sn={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},xn=e=>(...t)=>({_$litDirective$:e,values:t}),En=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Co=xn(class extends En{constructor(e){var t;if(super(e),e.type!==Sn.ATTRIBUTE||e.name!=="class"||((t=e.strings)===null||t===void 0?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var r,o;if(this.et===void 0){this.et=new Set,e.strings!==void 0&&(this.st=new Set(e.strings.join(" ").split(/\s/).filter(n=>n!=="")));for(const n in t)t[n]&&!(!((r=this.st)===null||r===void 0)&&r.has(n))&&this.et.add(n);return this.render(t)}const i=e.element.classList;this.et.forEach(n=>{n in t||(i.remove(n),this.et.delete(n))});for(const n in t){const s=!!t[n];s===this.et.has(n)||((o=this.st)===null||o===void 0?void 0:o.has(n))||(s?(i.add(n),this.et.add(n)):(i.remove(n),this.et.delete(n)))}return q}});/**
 * @license
...
`,xe=class extends Ot{constructor(){super(...arguments);this.localize=new Ro(this)}render(){return Ne`
      <svg part="base" class="spinner" role="progressbar" aria-valuetext=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};xe.styles=qn;xe=v([Me("sl-spinner")],xe);const Kn=dt`
...
`;var Jn=Object.defineProperty,Yn=Object.getOwnPropertyDescriptor,Uo=(e,t,r,o)=>{for(var i=o>1?void 0:o?Yn(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(i=(o?s(t,r,i):s(i))||i);return o&&i&&Jn(t,r,i),i};let Ee=class extends M{constructor(){super();this.message="Welcome!"}static get styles(){return[Kn,dt`
    ...
    `}render(){return F`
      <header>
        ...
        <div id="back-button-block">
          ${this.enableBack?F`<sl-button href="${"/soundscape/"}">
            Back
          </sl-button>`:null}
    ...
    `}};Le([P({type:String})],Wt.prototype,"title",2);Le([P({type:Boolean})],Wt.prototype,"enableBack",2);Wt=Le([Pt("app-header")],Wt);var Zn=Object.defineProperty,Qn=Object.getOwnPropertyDescriptor,Tt=(e,t,r,o)=>{for(var i=o>1?void 0:o?Qn(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(i=(o?s(t,r,i):s(i))||i);return o&&i&&Zn(t,r,i),i};let lt=class extends M{constructor(){super();this.title="Example Title",this.audio="assets/audio/water_drips.mp3",this.bgimage="assets/covers/balloon-ride.jpg",this.enableBack=!1}static get styles(){return dt`
        ...
        `}constructor(){super()}firstUpdated(){var t;new I((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/soundscape/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await qo(()=>import("./app-about.3df15538.js"),[])}}]}])}render(){return F`
            <div>
                <main>
...
//# sourceMappingURL=index.215b09d5.js.map
