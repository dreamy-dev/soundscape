...
`;var Jn=Object.defineProperty,Yn=Object.getOwnPropertyDescriptor,Uo=(e,t,r,o)=>{for(var i=o>1?void 0:o?Yn(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(i=(o?s(t,r,i):s(i))||i);return o&&i&&Jn(t,r,i),i};let Ee=class extends M{constructor(){super();this.message="Welcome!"}static get styles(){return[Kn,dt`
        ...
        `}constructor(){super()}firstUpdated(){var t;new I((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/soundscape/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await qo(()=>import("./app-about.e8a302ac.js"),[])}}]}])}render(){return F`
            <div>
                <main>
...
//# sourceMappingURL=index.b1765e68.js.map
